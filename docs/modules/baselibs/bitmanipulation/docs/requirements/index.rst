...
.. comp_req:: Support for Bit Manipulation Utilities
   :id: comp_req__bitmanip__utilities
   :reqtype: Functional
   :security: NO
   :safety: ASIL_B
...
.. comp_req:: Support for Bitmask Operators for Enum Classes
   :id: comp_req__bitmanip__bitmask_operators
   :reqtype: Functional
   :security: NO
   :safety: ASIL_B
   :satisfies: feat_req__baselibs__bitmanipulation, feat_req__baselibs__core_utilities
...
.. comp_req:: Bounds and Safety Checks
   :id: comp_req__bitmanip__bounds_safety
   :reqtype: Functional
   :security: NO
   :safety: ASIL_B
   ...
   All bit manipulation functions shall check bounds and prevent data loss.

Non-Functional Requirements
===========================

.. comp_req:: Header-only API
   :id: comp_req__bitmanip__header_only
...
.. comp_req:: Exception-Free Operation
   :id: comp_req__bitmanip__exception_free_operation
   :reqtype: Non-Functional
   :security: NO
   :safety: ASIL_B
   ...
   The bit manipulation library shall operate without throwing C++ exceptions.
