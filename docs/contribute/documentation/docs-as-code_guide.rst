...
.. document:: Docs-As-Code Guide
   :id: doc__docs_as_code_guide
   :status: valid
   :version: 1
   :safety: QM
   :security: NO
...
This document gives an overview how to write and publish documentation using the S-CORE Docs-As-Code approach.
Details to be found at : https://eclipse-score.github.io/docs-as-code/main/
...
.. image:: _assets/drawio-editing.png
...
.. image:: _assets/example.drawio.svg
   :alt: Example Diagram
