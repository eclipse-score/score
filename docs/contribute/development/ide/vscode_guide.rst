...
.. document:: VSCode Guide
  :id: doc__vscode_guide
  :status: valid
  :version: 1
  :safety: QM
  :security: NO
...
For `VS Code <https://code.visualstudio.com/>` any preexisting configuration is provided via the workspace configuration in the directory <workspace_root/.vscode>. It includes
