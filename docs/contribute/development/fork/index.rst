...
.. document:: Forking Guide
   :id: doc__forking_guide
   :status: valid
   :version: 1
   :safety: QM
   :security: NO
...
.. image:: ../_assets/internal-first-workflow.drawio.svg
...
First and foremost see `GitHub's guide to working with forks <https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo>`_
...
Now you can create PRs from ``<feature-branch>`` to ``upstream/main`` directly. See `GitHub Docs - Creating a pull request from a fork <https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork>`_ for details.
