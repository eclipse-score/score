...
Naming Convention for Sphinx Needs UIDs
---------------------------------------

The naming convention for the Sphinx Needs UIDs of **all** elements shall be defined as follows:
