...
.. document:: Folder Structure Conventions
   :id: doc__git_folder_structure_conventions
   :status: valid
   :version: 1
   :safety: ASIL_B
   :security: NO
...
The following shows the folder structure of the platform repository <https://github.com/eclipse-score/score.
