...
class TestStandards:
    ...
    def test_check_standard_req_linked_item_via_the_compliance_gd_negative(self):
        ...
        verify_log_string(
            logger,
            f"Standard requirement `{need_1['id']}` is not linked to at least one item via the compliance-gd tag.",
    ...
    def test_check_standard_workproducts_linked_item_via_the_compliance_wp_negative(
        ...
        verify_log_string(
            logger,
            f"Standard workproduct `{need_1['id']}` is not linked to at least one item via the compliance-wp tag.",
            expect_location=False,
        )
    ...
    def test_check_workproduct_uniqueness_over_workflows_negative_wprkproduct_not_listed_in_any_workflow(
        ...
        verify_log_string(
            logger,
            f"Workproduct `{need_1['id']}` is not contained in any workflow, which is incorrect.",
            expect_location=False,
        )
    ...
    def test_check_workproduct_uniqueness_over_workflows_negative_wprkproduct_listed_in_multiple_workflows(
        ...
        verify_log_string(
            logger,
            f"Workproduct `{need_1['id']}` is contained in {2} workflows: {workflows_str}, which is incorrect.",
            expect_location=False,
        )
