...
.. _module_introduction:

Module Introduction
===================


.. document:: Module Introduction
   :id: doc__module_introduction
   :status: valid
   :version: 1
   :safety: QM
   :security: NO
...
As described in :ref:`Technology Introduction <technology_introduction>`, Eclipse S-CORE consists of multiple bazel modules,
