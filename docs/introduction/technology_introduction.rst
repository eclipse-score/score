...
.. _technology_introduction:

Technology Introduction
=======================

.. document:: Technology Introduction
   :id: doc__technology_introduction
   :status: valid
   :version: 1
   :safety: QM
   :security: NO
...
Eclipse S-CORE´s approach for technical integration is described in the :ref:`Integration Introduction <integration_introduction>`.
